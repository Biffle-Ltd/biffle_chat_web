        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              The premier creator-fan platform where storytellers connect directly with their audience.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><button onClick={() => onNavigate?.('creators')} className="text-gray-400 hover:text-white transition-colors">For Creators</button></li>
              <li><button onClick={() => onNavigate?.('home')} className="text-gray-400 hover:text-white transition-colors">For Fans</button></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><button onClick={() => onNavigate?.('safety')} className="text-gray-400 hover:text-white transition-colors">Safety & Compliance</button></li>
              <li><button onClick={() => onNavigate?.('support')} className="text-gray-400 hover:text-white transition-colors">Contact Us</button></li>
              {/* <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Report an Issue</a></li> */}
              <li><button onClick={() => onNavigate?.('guidelines')} className="text-gray-400 hover:text-white transition-colors">Community Guidelines</button></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm mb-4">
              ...
              <li><button onClick={() => onNavigate?.('support')} className="text-gray-400 hover:text-white transition-colors">Refund Policy</button></li>
            </ul>
            <div className="flex flex-col space-y-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xs text-gray-400">ISO 27001 Certified</span>
              </div>
            </div>
          </div>
        </div>
