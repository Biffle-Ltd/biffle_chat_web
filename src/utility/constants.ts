...
export const verifApiUri = 'https://prod.biffle.ai';
...
export const countryCodes = [
    ...
    { code: "+1", label: "🇰🇳 St. Kitts & Nevis" },
    { code: "+1", label: "🇱🇨 St. Lucia" },
    { code: "+1", label: "🇻🇨 St. Vincent & Grenadines" },
